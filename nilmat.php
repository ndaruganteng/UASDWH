...
<html>
  ...
  <body>
    ...
    <!--menu-->
    <nav class="navbar navbar-default navbar-custom navbar-dark bg-dark" style='background-color:black;'>
      <div class="container"> 
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SPK Metode Topsis Potongan Harga Untuk Konsumen</a>
        </div>
        ...
        <footer class="text-center">
          <div class="footer-below">
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
                <em>Copyright &copy; M Ndaru S - 19090021 - Politeknik Harapan Bersama 2022</em>
                </div>
              </div>
            </div>
          </div>
