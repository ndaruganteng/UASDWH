...
<html>
  ...
  <body>
    ...
    <!--menu-->
    <nav class="navbar navbar-default navbar-custom navbar-dark bg-dark" style='background-color:pink;'>
      <div class="container"> 
    ...
    if (isset($_POST['simpan'])) {
      ...
      // if ($row = $tambah->fetch_row()) {
        $masuk = "INSERT INTO tab_alternatif VALUES ('','".$alternatif."')";
